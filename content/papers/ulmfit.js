...
ideas:[
 {h:'3단계 파이프라인: 일반 LM → 도메인 LM → 분류기',
  ...
  d:'1) WikiText-103(기사 28,595개·1억 300만 단어)으로 범용 언어모델을 한 번 학습한다. 2) 그 LM을 목표 과제의 (라벨 없는) 텍스트로 한 번 더 미세조정해 도메인 특유의 어휘·문체에 적응시킨다. 3) 그 위에 작은 분류층을 얹어 라벨 데이터로 미세조정한다. 3단계 모두 **같은 3층 LSTM(AWD-LSTM)**을 쓴다 — 과제마다 새 아키텍처를 설계하지 않는다.'},
