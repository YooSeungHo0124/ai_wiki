...
tldr:'text-to-image 확산 모델에서 **텍스트 인코더를 키우는 쪽이 이미지 확산 모델(U-Net)을 키우는 쪽보다 훨씬 효과적**이라는 것을 보인 논문. 이미지-텍스트 쌍으로 학습한 CLIP류 인코더 대신, 텍스트만으로 학습한 **얼린 [T5](#/p/t5)-XXL**을 그대로 가져다 썼다.',
