...
ideas:[
 {h:'Slow 경로 — 느리지만 채널이 두터운 의미 인식기',
  ...
  d:'64프레임 원본 클립에서 성긴 간격으로 $T$ 프레임만 뽑아(전형적으로 $\\tau=16$, 즉 16프레임마다 1장) 3D [ResNet](#/p/resnet)에 넣는다. 프레임 수는 적지만 채널 수(공간 표현력)는 많이 유지해, "사람"·"공"처럼 시간에 걸쳐 거의 변하지 않는 카테고리 정보를 깊게 인식한다.',
  },
