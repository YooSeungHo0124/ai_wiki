...
tldr:'MoE 라우팅을 **전문가 하나(top-1)** 로 단순화하고, 불안정한 학습을 잡는 세 가지 기법(선택적 float32, 작은 초기화, 전문가 드롭아웃)을 붙여 조 단위 파라미터 모델을 실제로 학습시킨 논문. 같은 연산 예산에서 [T5](#/p/t5)-Base 대비 사전학습 속도 최대 7배.',
