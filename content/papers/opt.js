...
ideas:[
 ...
 {h:'평가는 GPT-3 재현이 목적, 새 벤치마크가 아니다',
  ...
  d:'HellaSwag·PIQA·[SuperGLUE](#/p/superglue) 등 16개 표준 NLP 과제에서 GPT-3와 같은 프롬프트·평가 방식을 그대로 재현했다. zero-shot 평균은 GPT-3 추세를 대체로 따라가지만, few-shot(1-shot·32-shot)에서는 OPT가 GPT-3보다 낮은 경향을 보인다고 스스로 인정한다 — 공개 모델이 비공개 모델을 전 영역에서 이긴다고 과장하지 않은 점이 이례적이다.'}
],
...
numbers:[
 ...
 {k:'학습 데이터', v:'약 180B 토큰 (800GB)', d:'RoBERTa·[Pile](#/p/pile)·PushShift Reddit 혼합'},
