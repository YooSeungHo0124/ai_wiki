...
['integrated-gradients',2017,'Axiomatic Attribution for Deep Networks (Integrated Gradients)','Integrated Gradients','interp','xai',['saliency','grad-cam']],
['tcav',2017,'Interpretability Beyond Feature Attribution: Quantitative Testing with Concept Activation Vectors','TCAV 개념 활성 벡터','interp','xai',['grad-cam','integrated-gradients']],
...
['horovod',2018,'Horovod: fast and easy distributed deep learning in TensorFlow','Horovod · 링 올리듀스','efficiency','serve',['tensorflow','lr-scaling']],
...
// ════════ 16차 확장 — 채굴 9회차 ════════
['preference-ft',2019,'Fine-Tuning Language Models from Human Preferences','사람 선호로 LM 미세조정','llm','align',['gpt2','reward-modeling']],
['recursive-summary',2021,'Recursively Summarizing Books with Human Feedback','책을 재귀적으로 요약하기','llm','align',['summarize-hf','preference-ft']],
['convs2s',2017,'Convolutional Sequence to Sequence Learning','ConvS2S','nlp','seq',['seq2seq','bahdanau']],
['relative-pos',2018,'Self-Attention with Relative Position Representations','상대 위치 표현','efficiency','attn',['transformer']],
['rnn-regularization',2014,'Recurrent Neural Network Regularization','RNN 정칙화','nlp','seq',['lstm','dropout']],
['performer',2020,'Rethinking Attention with Performers','Performer','efficiency','attn',['transformer','reformer']],
['music-transformer',2018,'Music Transformer','Music Transformer','speech','music',['transformer','relative-pos']],
['squeezenet',2016,'SqueezeNet: AlexNet-level accuracy with 50x fewer parameters and <0.5MB model size','SqueezeNet','vision','cnn',['alexnet','googlenet']],
['dssd',2017,'DSSD: Deconvolutional Single Shot Detector','DSSD','vision','detect',['ssd','fpn']],
['rethinking-pretraining',2018,'Rethinking ImageNet Pre-training','ImageNet 사전학습 재고','vision','cnn',['imagenet','mask-rcnn']],
['shake-shake',2017,'Shake-Shake regularization','Shake-Shake 정칙화','vision','cnn',['resnet','cutout']],
['temporal-ensembling',2016,'Temporal Ensembling for Semi-Supervised Learning','시간적 앙상블','foundations','data',['dropout','batchnorm']],
['tcn',2018,'An Empirical Evaluation of Generic Convolutional and Recurrent Networks for Sequence Modeling','TCN 시퀀스 모델링','tabular','forecast',['lstm','convs2s']],
['visualbert',2019,'VisualBERT: A Simple and Performant Baseline for Vision and Language','VisualBERT','multimodal','vlm',['bert','faster-rcnn']],
['vl-t5',2021,'Unifying Vision-and-Language Tasks via Text Generation','VL-T5','multimodal','vlm',['t5','vilbert']],
['basic-scaling',2021,'Combined Scaling for Zero-shot Transfer Learning (BASIC)','BASIC 결합 스케일링','multimodal','contrastive',['align','clip']],
['lafite',2021,'LAFITE: Towards Language-Free Training for Text-to-Image Generation','LAFITE','generative','diffusion',['clip','stylegan']],
['socratic',2022,'Socratic Models: Composing Zero-Shot Multimodal Reasoning with Language','Socratic Models','agent','reason',['clip','gpt3']],
['ediff-i',2022,'eDiff-I: Text-to-Image Diffusion Models with an Ensemble of Expert Denoisers','eDiff-I','generative','diffusion',['imagen','ldm']],
['cogvideo',2022,'CogVideo: Large-scale Pretraining for Text-to-Video Generation via Transformers','CogVideo','video','generate',['vqvae','transformer']],
['maskgan',2018,'MaskGAN: Better Text Generation via Filling in the Blank','MaskGAN','generative','gan',['gan','seq2seq']],
['mt-bench',2023,'Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena','MT-Bench · LLM 평가자','interp','eval',['instructgpt','helm']],
['evalplus',2023,'Is Your Code Generated by ChatGPT Really Correct? Rigorous Evaluation of Large Language Models for Code Generation','EvalPlus','code','bench',['humaneval','apps']],
['codesearchnet',2019,'CodeSearchNet Challenge: Evaluating the State of Semantic Code Search','CodeSearchNet','code','bench',['word2vec','seq2seq']],
['sts-benchmark',2017,'SemEval-2017 Task 1: Semantic Textual Similarity','STS 벤치마크','interp','eval',['glove','word2vec']],
['lama-probe',2019,'Language Models as Knowledge Bases?','LM 은 지식 베이스인가','interp','interp',['bert','elmo']],
['dm-math',2019,'Analysing Mathematical Reasoning Abilities of Neural Models','수학 추론 능력 분석','interp','eval',['transformer','lstm']],
['explanations-icl',2022,'Can language models learn from explanations in context?','문맥 속 설명으로 배우기','agent','reason',['cot','gpt3']],
['lm-few-shot-better',2020,'Making Pre-trained Language Models Better Few-shot Learners (LM-BFF)','LM-BFF','llm','align',['gpt3','bert']],
['metaicl',2021,'MetaICL: Learning to Learn In Context','MetaICL','llm','align',['gpt3','natural-instructions']],
['scaling-inference',2022,'Efficiently Scaling Transformer Inference','Transformer 추론 스케일링','efficiency','serve',['palm','mqa']],
['lut-gemm',2022,'LUT-GEMM: Quantized Matrix Multiplication based on LUTs for Efficient Inference','LUT-GEMM','efficiency','quant',['gptq','llm-int8']],
['scaling-transfer',2021,'Scaling Laws for Transfer','전이의 스케일링 법칙','llm','scale',['scaling-laws','gpt3']],
['deepseek-llm',2024,'DeepSeek LLM: Scaling Open-Source Language Models with Longtermism','DeepSeek LLM','llm','open',['llama','chinchilla']],
['qwen',2023,'Qwen Technical Report','Qwen','llm','open',['llama','gpt3']],
['galactica',2022,'Galactica: A Large Language Model for Science','Galactica','llm','open',['opt','gpt3']],
['progressive-nn',2016,'Progressive Neural Networks','Progressive Neural Networks','foundations','meta',['backprop','a3c']],
['deep-infomax',2018,'Learning deep representations by mutual information estimation and maximization','Deep InfoMax','vision','selfsup',['cpc','gan']],
['universal-sentence-encoder',2018,'Universal Sentence Encoder','Universal Sentence Encoder','ir','embed',['transformer','glove']],
['safety-tooling',2021,'Anticipating Safety Issues in End-to-End Conversational AI: Framework and Tooling','대화형 AI 안전 프레임워크','privacy','safety',['ethical-risks','gpt3']],
['multimodal-datasets-audit',2021,'Multimodal datasets: misogyny, pornography, and malignant stereotypes','멀티모달 데이터셋 감사','data','curate',['laion400m','clip']],

// ════════ 17차 확장 — 2024~2025 후속작 ════════
['test-time-scaling',2024,'Scaling LLM Test-Time Compute Optimally can be More Effective than Scaling Model Parameters','테스트 타임 계산 확장','llm','scale',['cot','self-consistency']],
['s1-simple',2025,'s1: Simple test-time scaling','s1 단순 테스트타임 확장','llm','align',['deepseek-r1','test-time-scaling']],
['limo',2025,'LIMO: Less is More for Reasoning','LIMO','llm','align',['deepseek-r1','self-instruct']],
['kimi-k15',2025,'Kimi k1.5: Scaling Reinforcement Learning with LLMs','Kimi k1.5','llm','align',['deepseek-r1','ppo']],
['deliberative-alignment',2024,'Deliberative Alignment: Reasoning Enables Safer Language Models','숙고적 정렬','llm','align',['constitutional','instructgpt']],
['llama3',2024,'The Llama 3 Herd of Models','Llama 3','llm','open',['llama2','chinchilla']],
['qwen25',2024,'Qwen2.5 Technical Report','Qwen2.5','llm','open',['qwen','llama3']],
['gemma2',2024,'Gemma 2: Improving Open Language Models at a Practical Size','Gemma 2','llm','open',['gemini','distillation']],
['phi3',2024,'Phi-3 Technical Report: A Highly Capable Language Model Locally on Your Phone','Phi-3','llm','open',['phi-textbooks']],
['olmo2',2024,'2 OLMo 2 Furious','OLMo 2','llm','open',['olmo','dolma']],
['tulu3',2024,'TULU 3: Pushing Frontiers in Open Language Model Post-Training','Tulu 3','llm','align',['olmo','dpo']],
['qwen3',2025,'Qwen3 Technical Report','Qwen3','llm','open',['qwen25','deepseek-v3']],
['flashattention3',2024,'FlashAttention-3: Fast and Accurate Attention with Asynchrony and Low-precision','FlashAttention-3','efficiency','attn',['flashattention2']],
['nsa',2025,'Native Sparse Attention: Hardware-Aligned and Natively Trainable Sparse Attention','Native Sparse Attention','efficiency','attn',['sparse-attn','flashattention']],
['moba',2025,'MoBA: Mixture of Block Attention for Long-Context LLMs','MoBA','efficiency','attn',['switch','flashattention']],
['titans',2025,'Titans: Learning to Memorize at Test Time','Titans','efficiency','ssm',['mamba','transformer']],
['llada',2025,'Large Language Diffusion Models (LLaDA)','LLaDA 확산 언어모델','llm','pretrain',['ddpm','bert']],
['qwen2-vl',2024,'Qwen2-VL: Enhancing Vision-Language Model Perception of the World at Any Resolution','Qwen2-VL','multimodal','vlm',['qwen-vl','vit']],
['qwen25-vl',2025,'Qwen2.5-VL Technical Report','Qwen2.5-VL','multimodal','vlm',['qwen2-vl']],
['internvl25',2024,'Expanding Performance Boundaries of Open-Source Multimodal Models with Model, Data, and Test-Time Scaling','InternVL 2.5','multimodal','vlm',['internvl']],
['molmo',2024,'Molmo and PixMo: Open Weights and Open Data for State-of-the-Art Vision-Language Models','Molmo · PixMo','multimodal','vlm',['llava','clip']],
['janus-pro',2025,'Janus-Pro: Unified Multimodal Understanding and Generation with Data and Model Scaling','Janus-Pro','multimodal','vlm',['chameleon','vqvae']],
['sd3',2024,'Scaling Rectified Flow Transformers for High-Resolution Image Synthesis','Stable Diffusion 3','generative','diffusion',['ldm','flow-matching','dit']],
['movie-gen',2024,'Movie Gen: A Cast of Media Foundation Models','Movie Gen','video','generate',['ldm','imagen-video']],
['hunyuan-video',2024,'HunyuanVideo: A Systematic Framework For Large Video Generative Models','HunyuanVideo','video','generate',['ldm','dit']],
['cosmos',2025,'Cosmos World Foundation Model Platform for Physical AI','Cosmos 세계 모델','rl','world',['genie','dit']],
['moshi',2024,'Moshi: a speech-text foundation model for real-time dialogue','Moshi','speech','codec',['audiolm','encodec']],
['f5-tts',2024,'F5-TTS: A Fairytaler that Fakes Fluent and Faithful Speech with Flow Matching','F5-TTS','speech','tts',['flow-matching','vall-e']],
['cosyvoice',2024,'CosyVoice: A Scalable Multilingual Zero-shot Text-to-speech Synthesizer based on Supervised Semantic Tokens','CosyVoice','speech','tts',['vall-e','encodec']],
['simpo',2024,'SimPO: Simple Preference Optimization with a Reference-Free Reward','SimPO','llm','align',['dpo','orpo']],
['constitutional-classifiers',2025,'Constitutional Classifiers: Defending against Universal Jailbreaks across Thousands of Hours of Red Teaming','헌법적 분류기','privacy','safety',['constitutional','gcg']],
['bigcodebench',2024,'BigCodeBench: Benchmarking Code Generation with Diverse Function Calls and Complex Instructions','BigCodeBench','code','bench',['humaneval','evalplus']],
['bge-m3',2024,'BGE M3-Embedding: Multi-Lingual, Multi-Functionality, Multi-Granularity Text Embeddings','BGE-M3','ir','embed',['bge','colbert']],
['webarena',2023,'WebArena: A Realistic Web Environment for Building Autonomous Agents','WebArena','agent','tool',['react','reflexion']],
['osworld',2024,'OSWorld: Benchmarking Multimodal Agents for Open-Ended Tasks in Real Computer Environments','OSWorld','agent','tool',['webarena','react']],
['alphageometry2',2025,'Gold-medalist Performance in Solving Olympiad Geometry with AlphaGeometry2','AlphaGeometry2','science','math',['alphageometry']]
];
