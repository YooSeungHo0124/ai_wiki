...
tldr:'단어 벡터를 룩업 테이블에서 꺼내는 대신, **문장 전체를 읽은 양방향 [LSTM](#/p/lstm) 언어모델의 내부 상태에서 매번 새로 계산**하는 방식. 같은 단어라도 문맥이 다르면 다른 벡터가 나오고, 이 표현을 기존 모델의 입력에 얹는 것만으로 6개 과제에서 SOTA가 갈렸다.',
