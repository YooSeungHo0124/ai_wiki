...
ideas:[
 {h:'RPN: 특징 맵 위를 도는 작은 컨볼루션 네트워크',
  ...
  d:'백본의 마지막 특징 맵(VGG-16 기준 conv5) 위에 3×3 컨볼루션을 슬라이딩시키고, 각 위치에서 두 개의 1×1 컨볼루션 head가 **objectness 점수(2k)** 와 **박스 보정량(4k)** 을 뱉는다. 전부 컨볼루션이라 이미지 크기와 무관하게 한 번의 forward로 모든 위치의 제안이 나온다. 추가 비용은 **약 10ms** — selective search의 2초에 비하면 사실상 공짜다.'},
