...
ideas:[
 ...
 {h:'통신과 계산을 완전히 겹친다',
  ...
  d:'각 장치는 attention과 feedforward를 계산하는 동시에 자신이 갖고 있던 key-value 블록을 다음 장치로 보내고, 이전 장치로부터 다음 블록을 받는다. 블록 크기 $c$ 를 장치의 연산 성능 $F$(FLOPS)와 장치 간 대역폭 $B$ 로부터 $c \\geq F/B$ 가 되도록 정하면, 통신 시간이 계산 시간보다 항상 짧아 **통신이 전혀 병목이 되지 않는다** — 표준 Transformer 대비 추가 오버헤드가 이론상 0이다.'},
